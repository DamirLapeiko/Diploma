...
insert into country (id, name, admin_id) values (10, 'Sri Lanka', 1);
insert into country (id, name, admin_id) values (11, 'Guatemala', 1);
insert into country (id, name, admin_id) values (12, 'Egypt', 1);
insert into country (id, name, admin_id) values (13, 'Japan', 1);
insert into country (id, name, admin_id) values (14, 'Georgia', 1);
insert into country (id, name, admin_id) values (15, 'Madagascar', 1);
insert into country (id, name, admin_id) values (16, 'Spain', 1);
insert into country (id, name, admin_id) values (17, 'Greece', 1);
insert into country (id, name, admin_id) values (18, 'Tanzania', 1);
insert into country (id, name, admin_id) values (19, 'Greenland', 1);
insert into country (id, name, admin_id) values (20, 'Barbados', 1);
insert into country (id, name, admin_id) values (21, 'Angola', 1);
insert into country (id, name, admin_id) values (22, 'Jamaica', 1);
insert into country (id, name, admin_id) values (23, 'Columbia', 1);
insert into country (id, name, admin_id) values (24, 'Peru', 1);
insert into country (id, name, admin_id) values (25, 'Saint Lucia', 1);
insert into country (id, name, admin_id) values (26, 'Honduras', 1);
insert into country (id, name, admin_id) values (27, 'Bouvet Island', 1);
insert into country (id, name, admin_id) values (28, 'Myanmar', 1);
insert into country (id, name, admin_id) values (29, 'Tuvalu', 1);
insert into country (id, name, admin_id) values (30, 'Gabon', 1);
...
insert into hotel (id, name, stars, features, admin_id) values (10, 'Rice-Daugherty', 1, 'WITH_MINI_BAR', 1);
insert into hotel (id, name, stars, features, admin_id) values (11, 'Rolfson, Bergnaum and Glover', 1, 'HAS_A_PRESIDENT_ROOM', 1);
insert into hotel (id, name, stars, features, admin_id) values (12, 'KWill and Sons', 3, 'WITH_WIFI', 1);
insert into hotel (id, name, stars, features, admin_id) values (13, 'Ruecker and Sons', 4, 'WITH_CINEMA', 1);
insert into hotel (id, name, stars, features, admin_id) values (14, 'Marks, Satterfield and VonRueden', 3, 'NEAR_THE_BEACH', 1);
insert into hotel (id, name, stars, features, admin_id) values (15, 'Padberg-Ziemann', 5, 'WITH_PARKING', 1);
insert into hotel (id, name, stars, features, admin_id) values (16, 'Altenwerth-Blanda', 3, 'ALL_INCLUSIVE', 1);
insert into hotel (id, name, stars, features, admin_id) values (17, 'Armstrong and Sons', 4, 'WITH_SWIMMING_POOL', 1);
insert into hotel (id, name, stars, features, admin_id) values (18, 'Lang Inc', 3, 'WITH_PARKING', 1);
insert into hotel (id, name, stars, features, admin_id) values (19, 'Ebert Group', 3, 'NEAR_THE_BEACH', 1);
insert into hotel (id, name, stars, features, admin_id) values (20, 'Durgan, Carroll and Braun', 3, 'WITH_MINI_BAR', 1);
insert into hotel (id, name, stars, features, admin_id) values (21, 'Hagenes LLC', 3, 'WITHOUT_WIFI', 1);
insert into hotel (id, name, stars, features, admin_id) values (22, 'Beatty and Sons', 1, 'NEAR_THE_BEACH', 1);
insert into hotel (id, name, stars, features, admin_id) values (23, 'Thompson Inc', 4, 'WITH_MINI_BAR', 1);
insert into hotel (id, name, stars, features, admin_id) values (24, 'Abbott, Dibbert and Koss', 4, 'WITH_MINI_BAR', 1);
insert into hotel (id, name, stars, features, admin_id) values (25, 'Mosciski Inc', 2, 'WITH_PARKING', 1);
insert into hotel (id, name, stars, features, admin_id) values (26, 'McKenzie Group', 5, 'LOW_COST', 1);
insert into hotel (id, name, stars, features, admin_id) values (27, 'Dibbert, Doyle and Ortiz', 2, 'WITHOUT_WIFI', 1);
insert into hotel (id, name, stars, features, admin_id) values (28, 'Blanda, Pollich and Legros', 5, 'WITH_MINI_BAR', 1);
insert into hotel (id, name, stars, features, admin_id) values (29,'McDermott, Wolff and Pfannerstill', 4, 'WITHOUT_WIFI', 1);
insert into hotel (id, name, stars, features, admin_id) values (30, 'Skiles, Rohan and Hirthe', 3, 'LOW_COST', 1);
...
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (11, '2023-12-23', 24, 'Excision of Left Axilla, Percutaneous Endoscopic Approach', 743, 'WEEKEND_TOUR', 11, 11, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (12, '2022-10-10', 30, 'Supplement Left Thumb with Synthetic Substitute, Percutaneous Endoscopic Approach', 635, 'HEALTH_TOUR', 12, 12, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (13, '2024-01-06', 21, 'Revision of Infusion Device in Thoracic Duct, Percutaneous Endoscopic Approach', 627, 'CHILD_TOUR', 13, 13, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (14, '2022-03-03', 3, 'Revision of Intraluminal Device in Pancreatic Duct, Via Natural or Artificial Opening Endoscopic', 512, 'WEEKEND_TOUR', 14, 14, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (15, '2023-11-12', 20, 'Inspection of Pituitary Gland, Open Approach', 616, 'FAMILY_TOUR', 15, 15, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (16, '2022-11-24', 12, 'Alteration of Left Upper Arm Subcutaneous Tissue and Fascia, Percutaneous Approach', 549, 'SIGHTSEEING_TOUR', 16, 16, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (17, '2024-04-06', 13, 'Drainage of Right Lower Lung Lobe with Drainage Device, Via Natural or Artificial Opening Endoscopic', 512, 'FAMILY_TOUR', 17, 17, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (18, '2022-02-10', 11, 'Revision of Autologous Tissue Substitute in Face, External Approach', 853, 'BUS_TOUR', 18, 18, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (19, '2023-12-29', 16, 'Dilation of Gastric Artery, Bifurcation, with Two Intraluminal Devices, Percutaneous Endoscopic Approach', 541, 'WEEKEND_TOUR', 19, 19, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (20, '2022-12-12', 21, 'Removal of Nonautologous Tissue Substitute from Fallopian Tube, Via Natural or Artificial Opening', 725, 'WEEDING_TOUR', 20, 20, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (21, '2023-11-21', 19, 'Release Splenic Artery, Percutaneous Approach', 320, 'HEALTH_TOUR', 21, 21, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (22, '2022-10-21', 6, 'Destruction of Left Hip Joint, Percutaneous Endoscopic Approach', 668, 'CHILD_TOUR', 22, 22, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (23, '2024-01-11', 15, 'Magnetic Resonance Imaging (MRI) of Bilateral Submandibular Glands using Other Contrast', 836, 'WEEKEND_TOUR', 23, 23, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (24, '2022-12-13', 28, 'Supplement Left Elbow Joint with Synthetic Substitute, Percutaneous Approach', 881, 'WEEDING_TOUR', 24, 24, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (25, '2024-04-11', 15, 'Dilation of Right Temporal Artery, Bifurcation, with Three Drug-eluting Intraluminal Devices, Percutaneous Endoscopic Approach', 583, 'EVENT_TOUR', 25, 25, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (26, '2022-04-07', 14, 'Release Multiple Parathyroid Glands, Open Approach', 664, 'WEEKEND_TOUR', 26, 26, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (27, '2022-04-11', 24, 'Revision of Extraluminal Device in Hepatobiliary Duct, Percutaneous Endoscopic Approach', 785, 'FAMILY_TOUR', 27, 27, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (28, '2023-12-29', 21, 'Destruction of Bilateral Vas Deferens, Percutaneous Approach', 393, 'SIGHTSEEING_TOUR', 28, 28, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (29, '2023-03-16', 30, 'Excision of Sigmoid Colon, Via Natural or Artificial Opening Endoscopic', 489, 'SHOPPING_TOUR', 29, 29, 1);
insert into tour (id, date, duration, description, cost, tour_type, hotel_id, country_id, admin_id) values (30, '2022-11-14', 27, 'Excision of Right Ovary, Percutaneous Endoscopic Approach, Diagnostic', 971, 'SAFARI', 30, 30, 1);
